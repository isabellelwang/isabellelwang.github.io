...
if(isset($_POST["submit"])) {
    //Creating a new folder for the new picture 
    $target_dir = "../Users/User" . $userNum . "/";
    ...
    // upload fileL SOURCE: https://www.w3schools.com/php/func_filesystem_move_uploaded_file.asp
...
if (is_dir($userFolderAlt) && $userFolderAlt !== $userFolder) {
    $altImgs = glob($userFolderAlt . "*.{jpg,jpeg,png,gif}", GLOB_BRACE);
    if ($altImgs !== false) {
        $imgs = array_merge($imgs, $altImgs);
    }
}
